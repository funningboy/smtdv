...
#
#      irun -Wld,-Xlinker -Wld,-rpath -Wld,$UVM_ML_HOME/ml/frameworks/uvm/sc/64bit/ -Wcxx,-I$UVM_ML_HOME/ml/frameworks/uvm/sc/ -64bit -debug -g -uvmlinedebug ./test.sv +UVM_NO_RELNOTES -nocopyright -access rw -uvmhome $UVM_ML_HOME/ml/frameworks/uvm/sv/uvm-1.1c -sv_lib $UVM_ML_HOME/ml/backplane/ies_${IES_VERSION}/${UVM_ML_COMPILER_VERSION}/64bit/libml_uvm.so -L$UVM_ML_HOME/ml/frameworks/uvm/sc/64bit -DSC_INCLUDE_DYNAMIC_PROCESSES -sysc -tlm2 -I$UVM_ML_HOME/ml/frameworks/uvm/sv/uvm-1.1c/uvm_lib/uvm_ml/sc/uvm_ml -I$UVM_ML_HOME/ml/adapters/uvm_sc -I$UVM_ML_HOME/ml/adapters/uvm_sc/uvm_ml -I$UVM_ML_HOME/ml/adapters/uvm_sc/uvm_ml/ncsc ./sc.cpp -ml_uvm -top topmodule -sctlmrecord -scregisterproberecordall on -input restore.tcl
#
