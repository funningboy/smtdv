#!/bin/sh -e
#
# Script for running the UVM SystemVerilog Block Level demo
# 
...
usage() {
    ...
    echo "  <test_name> is one of the classes defined in: `/bin/ls $UVM_REF_HOME/soc_verification_lib/sv_cb_ex_lib/uart_ctrl/tb/tests` "
...
gmake -f ${UVM_REF_HOME}/soc_verification_lib/sv_cb_ex_lib/uart_ctrl/tb/scripts/Makefile $seed $run_mode $verbosity $test
