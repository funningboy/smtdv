...
if ( ! { (which vsim >& /dev/null) } ) then
    echo QUESTA installation not found
    exit 1
endif
...
setenv WRAPPER_SPECIFIC_HELP "This wrapper is aimed to build UVM-ML-OA in Questa/OSCI environment. Any Cadence Incisive-specific stuff is not being built.\
