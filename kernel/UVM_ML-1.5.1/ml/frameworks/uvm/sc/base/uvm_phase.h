...
class uvm_phase;
typedef uvm_phase *puvm_phase;
typedef uvm_callback_agent<puvm_phase>   uvm_phase_callback_agent;
typedef uvm_callback_agent<puvm_phase> *puvm_phase_callback_agent;
...
public:
    ...
    virtual int do_state(uvm_phase_state state);

    virtual void execute_runtime_phase();
    virtual void execute_nonruntime_phase(sc_core::sc_module* pmod);
    ...
    puvm_phase_callback_agent get_callback_agent(uvm_phase_state state);
...
protected:
    ...
    std::map<uvm_phase_state, puvm_phase_callback_agent> _callback_map;
