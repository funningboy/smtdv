...
*/
class uvm_schedule;
typedef uvm_schedule *puvm_schedule;


class uvm_schedule : public sc_module
{
public:
    friend class uvm_phase_controller;
    ...
    virtual void do_run(void);      // execute the 'run' time phases in the schedule
    virtual uvm_phase * set_phase(std::string phase, uvm_phase_state state);
...
protected:
    virtual uvm_phase_state update_phase_state();
    virtual void execute_nonruntime_phase(sc_core::sc_module *pmod);
    virtual void execute_runtime_phase(void);
