...
//------------------------------------------------------------------------------
uvm_barrier::uvm_barrier(const std::string & name) :
    _n_barriers(0),
    _name(name),
    _drain_time(SC_ZERO_TIME)
{
    
    puvm_barrier_callback_agent p_callback_agent;

    p_callback_agent = new uvm_barrier_callback_agent();
...
//------------------------------------------------------------------------------
puvm_barrier_callback_agent uvm_barrier::get_callback_agent(uvm_barrier_cb_type barrier_action)
{
