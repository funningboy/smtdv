...
//----------------------
  ...
  extern protected task  execute_phase(uvm_component comp = null, bit bsequential = 0);
//--------------------
// ML Additions (END)
//--------------------
...
// ML Additions (START)
//----------------------
    if (bsequential == 0)  // ML - Modification
//--------------------
// ML Additions (END)
//--------------------
      #0;
...
//    m_imp.traverse(top,this,UVM_PHASE_STARTED);
  if (!$cast(task_phase,m_imp))
    m_imp.traverse(traverse_top,this,UVM_PHASE_STARTED);
  else begin
    m_imp.traverse(top,this,UVM_PHASE_STARTED);
  end
//--------------------
...
//      m_imp.traverse(top,this,UVM_PHASE_EXECUTING);
      m_imp.traverse(traverse_top,this,UVM_PHASE_EXECUTING);
//--------------------
// ML Additions (END)
//--------------------
...
// ML Additions (START)
//----------------------
            // Task phase shall be always traversed from top (via parent proxy components for child sub-trees
            // because these phases are not transmitted hierarchically
//----------------------
// ML Additions (END)
//----------------------
...
//----------------------
      // if (task_phase == null)
      if ((task_phase == null) && (bsequential == 0))
//--------------------
// ML Additions (END)
//--------------------
        m_wait_for_pred();
...
//      m_imp.traverse(top,this,UVM_PHASE_ENDED);
      if (!$cast(task_phase,m_imp))
        m_imp.traverse(traverse_top,this,UVM_PHASE_ENDED);
      else begin
        m_imp.traverse(top,this,UVM_PHASE_ENDED);
      end
