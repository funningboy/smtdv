...
function void uvm_packer::pack_field_int(uvm_integral_t value, int size);
  ...
  // ML Additions (START)
  //----------------------
  // The implementation of this function shall be replicated in pack_field_array_int_element
...
function uvm_integral_t uvm_packer::unpack_field_int(int size);
  ...
  // ML Additions (START)
  //----------------------
  // The implementation of this function shall be replicated in unpack_field_array_int_element
  // (in order to save runtime performance)
  //----------------------
  // ML Additions (END)
  //----------------------
