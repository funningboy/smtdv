...
// ML Additions (START)
//----------------------
   // uvm_string_to_bits = str;
   typedef logic[UVM_LARGE_STRING:0] uvm_large_string_logic_arr;

   uvm_string_to_bits = uvm_large_string_logic_arr'(str);
//----------------------
// ML Additions (END)
//----------------------
endfunction
...
// ML Additions (START)
//----------------------
  // uvm_bits_to_string = str;
  uvm_bits_to_string = string'(str);
//----------------------
// ML Additions (END)
//----------------------
endfunction
