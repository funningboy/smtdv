...
public:
    ...
    */
     ...
     */
    const string & GetIntfName() { return m_intf_name; }
    ///////////////////////////////////////////////////////////////
...
public:
    ...
    //
    const string &         GetIntfName() const { return m_connector_descriptor->GetIntfName(); }
    //
    ...
    //
    bool CheckInRange(const string &root_name);
    //
    string GetTypeName();
    ///////////////////////////////////////////////////////////////
    ...
    {
    public:
        PathComparer(const string & s): BpStringComparer(s) { }
        ~PathComparer() {}
