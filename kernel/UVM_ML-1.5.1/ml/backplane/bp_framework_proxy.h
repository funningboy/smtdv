...
public:
    ...
    //
    BpTopDescriptorClass * GetTopLevel(int i) { return m_top_level_components[i]; }
    ///////////////////////////////////////////////////////////////
    ...
    //
    const string &             GetTopComponentForArg(const string & arg);
    //
    int                        GetConnectionBindKey(const string & path);
    //
    const string &             GetConnectionIntfName(int bindKey);
    //
    ...
    //
    const string &             GetTypeName(uvm_ml_type_id_t typeId,
                                           bool             getBaseName);
    // 
    ...
    int PhaseSrvCheckPhase(const char *      phaseName);

    int PhaseSrvCheckFuturePhase(const char *      phaseName,
				 uvm_ml_phase_action phaseAction);
    ...
    unsigned int           TransportDbgTLM2(int                bindKey,
                                            ...
                                            double             timeValue);
    //
    void                   TurnOffTransactionMapping(const string & socketName);
    //
    ...
    //////////////////////////////////////////////////////////////
    // Time-based callback routines                             //
    //////////////////////////////////////////////////////////////

    uvm_ml_handle RegisterTimeCallback(int              targetFrameworkId,
    		                       uvm_ml_time_unit time_unit,
    		                       double           time_value,
    		                       void *           cb_data);

    int RemoveTimeCallback(uvm_ml_handle cb_handle);

    void NotifyTimeCallback(uvm_ml_time_unit time_unit,
    		            double time_value,
    		            void *cb_data);
    ...
    //
    //////////////////////////////////////////////////////////////////////////////////
    //                    ML Event Propagation method
    //////////////////////////////////////////////////////////////////////////////////
    //
    void NotifyEvent( const char *                   scope_name,
    ...
    //
    //////////////////////////////////////////////////////////////////////////////////
    //                    ML Barrier Propagation method
    //////////////////////////////////////////////////////////////////////////////////
    //
    void NotifyBarrier( const char *                   scope_name,
    ...
    void PrintSrvRequest(const string & message);

    //////////////////////////////////////////////////////////////
    // Debug print tree                                         //
    //////////////////////////////////////////////////////////////

    int  GetNumChildren(const string & componentName);
    const string & GetChildName(const string & parentName, int num);
    const string & GetComponentTypeName(const string & componentName);
    bool IsPort(const string & componentName);

    //////////////////////////////////////////////////////////////
    // Notify a generic command
    //////////////////////////////////////////////////////////////

    int NotifyCommand(const string & command, bp_output_cb_t * outputCb, uvm_ml_time_unit timeUnit, double timeValue);
    
    //////////////////////////////////////////////////////////////
    // Backlog-related methods
    //////////////////////////////////////////////////////////////
    //
    void BacklogCommands(const vector<string> & commands);
    //
    void ExecuteBacklogCommands();
    ...
    //
    const string &         GetShortName(const string & qualifiedName);
    //
    ...
    {
    public:
        FrameworkNameComparer(const string & s): BpStringComparer(s) { }
...
private:
    ...
    vector<string>                                               m_command_backlog;
                                                                 //helper to call NotifyCommand for all backlog commands
    void                                                         callNotifyCommand(string cmd); 
};
