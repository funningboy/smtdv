...
typedef struct frmw_srv_provider_struct
{
    ...
    FrameworkProxyClass * wakeup_srv_provider;  /// Wakeup service provider
    FrameworkProxyClass * stopper_srv_provider; /// Stopper service provider for phase debugging
    FrameworkProxyClass * print_srv_provider;   /// Print service provider
...
public:
     ...
     */
    static int RegisterFramework(const string &         frameworkName,
     ...
     */
    static int PhaseSrvCheckPhase(const char *      phaseName);
     ...
     *  @return  Return status
     *           - 1 : success
     *           - 0 : phase passed already
     */
    static int PhaseSrvCheckFuturePhase(const char * phaseName, uvm_ml_phase_action phaseAction);
    ...
    static void print_format_va_list(int level, const char * caller_name, const char *fstring, va_list & args);
     ...
     */
    static const string &         GetTypeNameByTypeId(int              frameworkId,
    ...
    //
    static void NotifyConfig(int              frameworkId,
                             const char *     cntxt,
    ...
    //
    static void NotifyEvent( int                            framework_id,
   ...
   ///////////////////////////////////////////////////////////////////////////////
    ...
    //-----------------------------------------------------------------------------
    //! Barrier notification call
    //
    static void NotifyBarrier( int                            framework_id,
                               const char *                   scope_name,
    ...
    static int                    GetConnectorSize(int frameworkId,int producer_id);
    ...
    /////////////////////////////////////////////////////////////////////////////// 
    static void Synchronize(int              frameworkId, 
                            uvm_ml_time_unit timeUnit,
                            double           timeValue);

    static uvm_ml_handle RegisterTimeCallback(int              frameworkId,
                                              uvm_ml_time_unit timeUnit,
                                              double           timeValue,
                                              void *           cbData);

    static int RemoveTimeCallback(int           frameworkId,
                                  uvm_ml_handle cb_handle);

    static void NotifyTimeCallback (int              frameworkId,
    ...
    static void StopPhase();
    static void PrintMessage(const string & message);
    static void PrintMessage(const char *formatString, ...);
     ...
     *          - 0 : upon an error
     */
    static bp_api_struct * Bootstrap( vector<string>  & tops,
                                      vector<string>  & tests,
                                      bp_serror_t   *   serror);
...
public:
    ...
    //
    static BpConnectionClass *        AddConnection(const string & path);
    //
    static int                        GetTraceMode();
    //
    static void                       DebugTrace(const char *formatString, ...);
    //
    static void                       ErrorMsg(const char *formatString, ...);
    //
    static void                       WarningMsg(const char *formatString, ...);
    //
    ...
    static void                       AddFrmwIndicator(const string & indicator, FrameworkProxyClass * frmw);


    static void                       SERROR(int msgId, const string & msg);
    static void                       SERROR2(int msgId, const char * fmt, const string & msg, const string & msg1);
    static void                       SERROR3(int msgId, const char * fmt, const string & msg, const string & msg1, const string & msg2);
    ////////////////////////////////////////////////////////////////////////////////

#include "bp_command_options.h"
#include "bp_debug.h"


    static BpStopRequestClass m_debug_requests;
    static string             m_current_phase_name;
    static bool               m_first_phase;
...
private:
    ...
    //
    static vector<string>                       m_cmd_line_tops;
    //
    static vector<string>                       m_cmd_line_tests;
    //
    static frmw_srv_provider_struct             m_srv_providers;
    //
    static FrameworkProxyClass *                m_common_frmw;
    //
    // A framework can register top components during static
                                                        // elaboration (e.g. to enable TLM communication with static ports).
                                                        // Such registered components must be preserved
                                                        // since they will not be re-registered in subsuquent run_test's
    static bool                              m_first_time_prerun_cleanup_invocation;
    //
    static unsigned                          m_top_level_registry_static_size;  
public:
...
private:
    static void                       identifyTestComponent(const string & arg);

    static void                       identifyTopComponent(const string & arg);
    ...
    static FrameworkProxyClass *      addFramework(const string &         frameworkName,
                                                   vector<string> &       frameworkIndicators,
                                                   bp_frmw_c_api_struct * requiredApi);

    static void                       setComponentFrameworks();

    static FrameworkProxyClass *      findFrameworkForPath(const string & path, bool checkConnector);
