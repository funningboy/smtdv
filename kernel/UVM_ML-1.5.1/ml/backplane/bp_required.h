...
//------------------------------------------------------------------------------
//! typedef for set_trace_mode function ptr
...
//------------------------------------------------------------------------------
//! typedef for transmit_phase function ptr
...
//------------------------------------------------------------------------------
//! typedef for notify_phase function ptr
...
//------------------------------------------------------------------------------
//! typedef for notify_runtime_phase function ptr
...
//------------------------------------------------------------------------------
//! typedef for phase_srv_start function ptr
/*! Called to phase service provider to start phasing.
 */
typedef void (*frmw_phase_srv_start_type) ();

//------------------------------------------------------------------------------
//! typedef for phase_srv_notify_phase_done function ptr
...
//------------------------------------------------------------------------------
//! typedef for phase_srv_check_phase function ptr
/*! Call to phase service provider to check valid phase name
 *
 *  @param phase_name    - Name of the phase
 *  @return Return status
 *           - 1 : success
 *           - 0 : error
 */
typedef int (*frmw_phase_srv_check_phase_type) 
(
    const char *      phase_name
);

//------------------------------------------------------------------------------
//! typedef for phase_srv_check_future_phase function ptr
/*! Call to phase service provider to check if phase passed
 *
 *  @param phase_name    - Name of the phase
 *  @param phaseAction   - The action for this phase
 *  @return Return status
 *           - true  : success
 *           - false : phase passed already
 */
typedef int (*frmw_phase_srv_check_future_phase_type) 
(
    const char *        phase_name,
...
//------------------------------------------------------------------------------
//! typedef for find_connector_id_by_name function ptr
...
//------------------------------------------------------------------------------
//! typedef for get_connector_intf_name function ptr
...
//------------------------------------------------------------------------------
//! typedef for is_export_connector function ptr
...
//------------------------------------------------------------------------------
//! typedef for get_connector_type function ptr
...
//------------------------------------------------------------------------------
//! typedef for external_connector function ptr
//
...
//------------------------------------------------------------------------------
//! typedef for notify_end_blocking function ptr
...
//------------------------------------------------------------------------------
//! typedef for try_put_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for can_put function ptr
...
//------------------------------------------------------------------------------
//! typedef for put_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for put_uvm_ml_stream_request function ptr
...
//------------------------------------------------------------------------------
//! typedef for get_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for get_uvm_ml_stream_request function ptr
...
//------------------------------------------------------------------------------
//! typedef for get_requested_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for try_get_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for can_get function ptr
...
//------------------------------------------------------------------------------
//! typedef for peek_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for peek_uvm_ml_stream_request function ptr
...
//------------------------------------------------------------------------------
//! typedef for peek_requested_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for try_peek_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for can_peek function ptr
...
//------------------------------------------------------------------------------
//! typedef for transport_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for transport_uvm_ml_stream_request function ptr
...
//------------------------------------------------------------------------------
//! typedef for transport_response_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for nb_transport_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for write_uvm_ml_stream function ptr
...
//------------------------------------------------------------------------------
//! typedef for tlm2_b_transport function ptr
...
//------------------------------------------------------------------------------
//! typedef for tlm2_b_transport_request function ptr
...
//------------------------------------------------------------------------------
//! typedef for tlm2_b_transport_response function ptr
...
//------------------------------------------------------------------------------
//! typedef for tlm2_nb_transport_fw function ptr
...
//------------------------------------------------------------------------------
//! typedef for tlm2_nb_transport_bw function ptr
...
//------------------------------------------------------------------------------
//! typedef for tlm2_transport_dbg function ptr
...
//------------------------------------------------------------------------------
//! typedef for tlm2_turn_off_transaction_mapping function ptr
...
//------------------------------------------------------------------------------
//! typedef for synchronization function ptr
...
//------------------------------------------------------------------------------
//! typedef for frmw_wakeup_srv_register_time_cb function ptr
/*! Registers a time-based callback at the notification service
 *
 *  @param target_framework_id     - framework to be notified of the callback
 *  @param time_unit               - time unit
 *  @param time_value              - simulation time at which the callback is requested
 *  @param cb_data                 - optional data to pass back when the callback is triggered
 *
 * @return Unique callback handle
 *           - non-null : success
 *           - 0 : error
 */

typedef uvm_ml_handle (*frmw_wakeup_srv_register_time_cb_type) 
(
...
//------------------------------------------------------------------------------
//! typedef for frmw_wakeup_srv_remove_time_cb function ptr
/*! Cancels a previously registered time-based callback
 *
...
typedef int (*frmw_wakeup_srv_remove_time_cb_type) 
(
    uvm_ml_handle cb_handle
);

//------------------------------------------------------------------------------
//! typedef for frmw_notify_time_cb function ptr
/*! Notifies the adapter of a time-related callback it previously requested
 *
 *  @param time_unit               - time unit as contained in the previous request
 *  @param time_value              - time value of the current system time
 *  @param cb_data                 - callback-related data passed in at registration
 *
 */

typedef void (*frmw_notify_time_cb_type)
(
    uvm_ml_time_unit   time_unit,
    double             time_value,
    void *             cb_data
...
//------------------------------------------------------------------------------
//! typedef for frmw_stopper_srv_stop_request function ptr
/*! Request immediate break
 *
 */

typedef void (*frmw_stopper_srv_stop_request_type) 
(
);
...
//------------------------------------------------------------------------------
//! typedef for frmw_print_srv_print_request function ptr
/*! Request printing of message
 *
 *  @param message                 - message to be printed
 */

typedef void (*frmw_print_srv_print_request_type) 
(
    const char* message
);
...
//------------------------------------------------------------------------------
//! typedef for create_child_junction_node function ptr
...
typedef void (*frmw_notify_event_type)
(
...
typedef void (*frmw_notify_barrier_type)
(
    const char *                   scope_name,
...
typedef int (*frmw_get_num_children_type)
(
    const char *     instance_name
);

typedef const char * (*frmw_get_child_name_type)
(
    const char *     parent_name,
    unsigned int     num
);

typedef const char * (*frmw_get_component_type_name_type)
(
    const char *     parent_name
);

typedef int (*frmw_is_port_type)
(
...
//------------------------------------------------------------------------------
//! typedef for notify_command function pointer
/*! Propagate a user command string to the framework adapter
 *
 *  @param command                 - string representation of the command (adapter can execute or ignore it)
 *  @param output_cb               - callback function pointer (optional) - if the command originator wants to get the output
 *  @param time_unit               - time unit
 *  @param time_value              - time value of the current system time
 *
 *  @return Return status
 ...
 *
 */
typedef int (*frmw_notify_command_type)
(
    const char *     command,
...
// ------ Time-based callbacks
    BP_REQUIRED_API_FUNCTION(notify_time_cb);
...
// ---- Wakeup callback service API
    BP_REQUIRED_API_FUNCTION(wakeup_srv_register_time_cb);
    BP_REQUIRED_API_FUNCTION(wakeup_srv_remove_time_cb);

// ---- Stopper service API
    BP_REQUIRED_API_FUNCTION(stopper_srv_stop_request);
...
// ---- Print service API
    BP_REQUIRED_API_FUNCTION(print_srv_print_request);

// ---- Command notification API
    BP_REQUIRED_API_FUNCTION(notify_command);
