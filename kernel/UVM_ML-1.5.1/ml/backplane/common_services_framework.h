...
public:
   ...
   static void phase_srv_notify_phase_done(unsigned int      frameworkId,
                                           ...
                                           double            timeValue);
   static int phase_srv_check_phase(const char * phaseName);
   static int phase_srv_check_future_phase(const char * phaseName, uvm_ml_phase_action phaseAction);
   static void print_srv_print_request(const char * message);

private:

    static CommonServicesFramework * m_common_services_frmw;
    static UvmMlPhaseService *       m_phase_service;
    static UvmMlPrintService *       m_print_service;
