...
uvm_ml_handle uvm_ml_sv_register_time_cb(int              adapter_id,
                                         uvm_ml_cb_reason reason, 
                                         uvm_ml_time_unit time_unit, 
                                         double           value, 
                                         void *           user_data );

int uvm_ml_sv_remove_time_cb(uvm_ml_handle cb_handle);

void stop_request();

void uvm_ml_sv_notify_event ( const char *                  scope_name,
                              const char *                  event_name,
                              uvm_ml_event_notify_action    action,
                              unsigned int                  stream_size,
                              uvm_ml_stream_t               stream);

void uvm_ml_sv_notify_barrier ( const char *                  scope_name,
