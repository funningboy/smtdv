...
void uvm_ml_register( 
  ...
  T* t_ptr = 0;
  uvm_ml_register_internal(p, t_ptr);
} 
...
/////////////////////////////////////////////////////////////////////////
/// \param command - a string reference to the UVM-ML command to be executed
/// \param error_severity - sc_severity argument indicating the effect in case of an error
/// \return 1 - upon success, 0 - failure, (-1) - unrecognized command
...
static int dummy_##w UVM_UNUSED_ATTR= associate_module(#w, F_##w);
#else
