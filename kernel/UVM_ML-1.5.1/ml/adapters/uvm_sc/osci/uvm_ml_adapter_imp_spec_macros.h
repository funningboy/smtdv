...
#define UVM_ML_QUASI_STATIC_END_OF_SIMULATION() sc_get_curr_simcontext()->end()
...
#define ENTER_CO_SIMULATION_CONTEXT() uvm_ml_sync::pre_sync(time_unit, time_value);
...
#define EXIT_CO_SIMULATION_CONTEXT() uvm_ml_sync::post_sync();

#define EXIT_CO_SIMULATION_CONTEXT2() uvm_ml_sync::post_sync();

#define EXIT_CO_SIMULATION_CONTEXT3() uvm_ml_sync::post_sync();
...
#define UVM_ML_DOTTED_NAME_SUPPORTED() true
...
#define UVM_ML_ENABLE_DOTTED_NAME()				       \
  bool sav_sc_enable_name_checking = sc_core::sc_enable_name_checking; \
  sc_core::sc_enable_name_checking = false;

#define UVM_ML_RESTORE_ENABLE_DOTTED_NAME()				\
  sc_core::sc_enable_name_checking = sav_sc_enable_name_checking;
#endif
