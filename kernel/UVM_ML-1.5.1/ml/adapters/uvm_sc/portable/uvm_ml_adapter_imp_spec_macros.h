...
#define QUASI_STATIC_CONSTRUCT_TOP(name1,name2)


#define UVM_ML_QUASI_STATIC_END_OF_CONSTRUCTION()

#define UVM_ML_QUASI_STATIC_CONNECT()

#define UVM_ML_QUASI_STATIC_END_OF_ELABORATION()

#define UVM_ML_QUASI_STATIC_START_OF_SIMULATION()

/// FIXME - Temporarily add macro until there is a proper PORTABLE version of this
...
#define CO_SIMULATION_EXECUTE_DELTA() 1
//(sc_get_curr_simcontext()->simulate(sc_time(0.0, false)),1)
...
//        sc_start(duration - sc_time_stamp());	\
    // }
//    else                                      \
...
#define EXIT_CO_SIMULATION_CONTEXT4()
#define EXIT_CO_SIMULATION_CONTEXT5()
...
#define UVM_ML_SC_REPORT_ERROR(msg1, msg2) SC_REPORT_ERROR(msg1, (string(msg2)+"\n").c_str())
