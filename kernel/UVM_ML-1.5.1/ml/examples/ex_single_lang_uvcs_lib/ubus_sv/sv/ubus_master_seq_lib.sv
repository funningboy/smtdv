...
class read_byte_seq extends ubus_base_sequence;
  ...
  `uvm_object_utils_begin(read_byte_seq)
    `uvm_field_int(start_addr, UVM_ALL_ON)
    `uvm_field_int(transmit_del, UVM_ALL_ON)
...
class read_half_word_seq extends ubus_base_sequence;
  ...
  `uvm_object_utils_begin(read_half_word_seq)
    `uvm_field_int(start_addr, UVM_ALL_ON)
    `uvm_field_int(transmit_del, UVM_ALL_ON)
  `uvm_object_utils_end
...
class read_word_seq extends ubus_base_sequence;
  ...
  `uvm_object_utils_begin(read_word_seq)
    `uvm_field_int(start_addr, UVM_ALL_ON)
    `uvm_field_int(transmit_del, UVM_ALL_ON)
  `uvm_object_utils_end
...
class read_double_word_seq extends ubus_base_sequence;
  ...
  `uvm_object_utils_begin(read_double_word_seq)
    `uvm_field_int(start_addr, UVM_ALL_ON)
    `uvm_field_int(transmit_del, UVM_ALL_ON)
  `uvm_object_utils_end
...
class write_byte_seq extends ubus_base_sequence;
  ...
  `uvm_object_utils_begin(write_byte_seq)
    `uvm_field_int(start_addr, UVM_ALL_ON)
...
class write_half_word_seq extends ubus_base_sequence;
  ...
  `uvm_object_utils_begin(write_half_word_seq)
    `uvm_field_int(start_addr, UVM_ALL_ON)
    `uvm_field_int(data0, UVM_ALL_ON)
...
class write_word_seq extends ubus_base_sequence;
  ...
  `uvm_object_utils_begin(write_word_seq)
     `uvm_field_int(start_addr, UVM_ALL_ON)
     `uvm_field_int(data0, UVM_ALL_ON)
     `uvm_field_int(data1, UVM_ALL_ON)
...
class write_double_word_seq extends ubus_base_sequence;
  ...
  `uvm_object_utils_begin(write_double_word_seq)
     `uvm_field_int(start_addr, UVM_ALL_ON)
     `uvm_field_int(data0, UVM_ALL_ON)
     `uvm_field_int(data1, UVM_ALL_ON)
     `uvm_field_int(data2, UVM_ALL_ON)
     ...
     `uvm_field_int(data5, UVM_ALL_ON)
     `uvm_field_int(data6, UVM_ALL_ON)
     `uvm_field_int(data7, UVM_ALL_ON)
     `uvm_field_int(transmit_del, UVM_ALL_ON)
 `uvm_object_utils_end
