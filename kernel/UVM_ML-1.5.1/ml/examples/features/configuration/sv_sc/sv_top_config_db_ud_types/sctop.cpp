...
public:
  ...
  void build() { 
    ...
    cout << "SC get_config: sc_active " << sc_active << endl;
    if (sc_active)
    ...
    if (lint != 0x7FFFFFFFFFFFFFFFLL)
      SC_REPORT_ERROR("MLCFGERR", "Incorrect long value");
    ...
    get_config_int("int_a", int_a);
    cout << "SC get_config: int almost = " << int_a << endl; 
    if (int_a != 0x1FFFFFFF)
        SC_REPORT_ERROR("MLCFGERR", "Incorrect int almost value");

    get_config_int("int_r_s", int_r_s);
    cout << "SC get_config: short reg = " << int_r_s << endl; 
    if (int_r_s != 0x7FFF)
        SC_REPORT_ERROR("MLCFGERR", "Incorrect short register value");

    get_config_int("long_a", long_a);
    cout << "SC get_config: long almost reg = " << long_a << endl; 
    if (long_a != 0x1FFFFFFFFFFFFFFFLL )
        SC_REPORT_ERROR("MLCFGERR", "Incorrect long almost register value");
    ...
    {
        SC_REPORT_ERROR("MLCFGERR", "Error getting config object");
    }
