...
#ifdef MTI_SYSTEMC
    etop = new child_component_proxy("my_unit");
#endif
  }
  void before_end_of_elaboration() {
...
#ifdef MTI_SYSTEMC
      assert (uvm_ml_create_component("e", "my_unit", "my_unit", this) == etop);
#else
...
public:
  ...
  void connect() { 
    ...
    uvm_ml_connect("sctop.sc_env.my_unit.outport", sc_env.cons.aexport.name());
    uvm_ml_connect(sc_env.prod.aport.name(), "sctop.sc_env.my_unit.inport");
#else
    uvm_ml_connect("sc_main/sctop/sc_env.my_unit.outport", sc_env.cons.aexport.name());
    uvm_ml_connect(sc_env.prod.aport.name(), "sc_main/sctop/sc_env.my_unit.inport");
#endif
  }
  void start_of_simulation() { 
